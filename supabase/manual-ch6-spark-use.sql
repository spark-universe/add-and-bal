...
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-01.webp" alt=""></figure>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-02.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-03.webp" alt=""></figure>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-04.webp" alt=""></figure>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-05.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-06.webp" alt=""></figure>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-07.webp" alt=""></figure>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-08.webp" alt=""></figure>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-09.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-10.webp" alt=""></figure>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-11.webp" alt=""></figure>

<h3 class="subhead">4. Prime 기능 (신기능)</h3>
<p>아마존에서 <b>프라임 제품만</b> 소싱하는 기능입니다. 링크를 넣고 <b>Prime</b> → 작업 시작을 누릅니다.</p>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-12.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-15.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-16.webp" alt=""></figure>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-17.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-18.webp" alt=""></figure>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-25.webp" alt=""></figure>

<h3 class="subhead">7. 데이터 관리 — 데이터 불러오기</h3>
<p>지금까지 소싱한 파일 중 <b>원하는 파일을 골라</b> 불러옵니다. <b>데이터 불러오기</b> → 파일 선택 → <b>폴더 선택</b> → 정상 로드 확인 순서입니다.</p>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-22.webp" alt=""></figure>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-23.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-24.webp" alt=""></figure>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-25.webp" alt=""></figure>

<h3 class="subhead">8. 데이터 관리 — 위치</h3>
<p>수집한 상품을 스토어에 올릴 때 <b>업로드 위치</b>를 지정하는 기능입니다. 데이터 불러오기에서 <b>위치: @@@</b> 부분을 눌러 위치를 선택합니다.</p>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-26.webp" alt=""></figure>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-27.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-28.webp" alt=""></figure>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-29.webp" alt=""></figure>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-30.webp" alt=""></figure>
<p>업로드 버튼이 <b>로딩 → 업로드 가능</b>으로 바뀌면 완료입니다. (안내 메시지는 자동으로 사라집니다.) 아래는 업로드 전/후 비교입니다.</p>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-31.webp" alt=""></figure>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-32.webp" alt=""></figure>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-33.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-34.webp" alt=""></figure>
<p>계정 설정에서는 <b>이름</b>(가입 시 이름)과 <b>아이디</b>(로그인 중인 스파크 ID)를 확인할 수 있습니다.</p>
<figure class="shot"><img loading="lazy" src="manual/images/spark-func-35.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-how-01.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-how-02.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-how-03.webp" alt=""></figure>

<div class="step"><span class="step-badge">STEP 4</span><span class="step-title">상세 카테고리 선택</span></div>
<p>이어서 <b>상세 카테고리</b>를 선택합니다.</p>
<figure class="shot"><img loading="lazy" src="manual/images/spark-how-04.webp" alt=""></figure>

<div class="step"><span class="step-badge">STEP 5</span><span class="step-title">상품군 선택</span></div>
<p>원하는 <b>상품군</b>을 클릭합니다.</p>
<figure class="shot"><img loading="lazy" src="manual/images/spark-how-05.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-how-06.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-how-07.webp" alt=""></figure>

<div class="step"><span class="step-badge">STEP 8</span><span class="step-title">수집 링크 추가</span></div>
<p>스파크에서 <b>수집 링크 추가</b>를 클릭합니다.</p>
<figure class="shot"><img loading="lazy" src="manual/images/spark-how-08.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-how-09.webp" alt=""></figure>

<div class="step"><span class="step-badge">STEP 10</span><span class="step-title">추가</span></div>
<p><b>추가</b>를 클릭합니다.</p>
<figure class="shot"><img loading="lazy" src="manual/images/spark-how-10.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-how-11.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-how-12.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-how-13.webp" alt=""></figure>
<figure class="shot"><img loading="lazy" src="manual/images/spark-how-14.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-how-15.webp" alt=""></figure>
<figure class="shot"><img loading="lazy" src="manual/images/spark-how-16.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-how-17.webp" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/spark-how-19.webp" alt=""></figure>
