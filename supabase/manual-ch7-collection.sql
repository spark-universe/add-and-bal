...
<figure class="shot"><img loading="lazy" src="manual/images/collection-create-01.png" alt=""></figure>

<div class="step"><span class="step-badge">STEP 2</span><span class="step-title">컬렉션 클릭</span></div>
<p>제품 아래의 <b>컬렉션</b>을 클릭합니다.</p>
<figure class="shot"><img loading="lazy" src="manual/images/collection-create-02.png" alt=""></figure>

<div class="step"><span class="step-badge">STEP 3</span><span class="step-title">컬렉션 생성 클릭</span></div>
<p>오른쪽 위 <b>컬렉션 생성</b>을 클릭합니다.</p>
<figure class="shot"><img loading="lazy" src="manual/images/collection-create-03.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-create-04.png" alt=""></figure>
<p>(참고) 본 매뉴얼은 아래와 같이 작성했습니다.</p>
<figure class="shot"><img loading="lazy" src="manual/images/collection-create-05.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-create-06.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-create-07.png" alt=""></figure>
<p>(참고) 본 매뉴얼은 아래와 같이 진행했습니다.</p>
<figure class="shot"><img loading="lazy" src="manual/images/collection-create-08.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-create-09.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-create-10.png" alt=""></figure>
<p>추가된 줄에도 같은 방식으로 원하는 조건을 입력하면 됩니다.</p>
<figure class="shot"><img loading="lazy" src="manual/images/collection-create-11.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-create-12.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-create-13.png" alt=""></figure>

<div class="step"><span class="step-badge">STEP 11</span><span class="step-title">파일 추가 클릭</span></div>
<p><b>파일 추가</b>를 클릭합니다.</p>
<figure class="shot"><img loading="lazy" src="manual/images/collection-create-14.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-create-15.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-create-17.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-create-18.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-create-19.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-apply-01.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-apply-02.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-apply-03.png" alt=""></figure>

<div class="step"><span class="step-badge">STEP 4</span><span class="step-title">추천 컬렉션 클릭</span></div>
<p>목록에서 <b>추천 컬렉션</b>을 클릭합니다.</p>
<figure class="shot"><img loading="lazy" src="manual/images/collection-apply-04.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-apply-05.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-apply-06.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-apply-07.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-apply-08.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-apply-09.png" alt=""></figure>
<p>(참고) <b>세로형</b>을 선택하면 다음과 같이 보입니다.</p>
<figure class="shot"><img loading="lazy" src="manual/images/collection-apply-10.png" alt=""></figure>
<p>(참고) <b>정사각형</b>을 선택하면 다음과 같이 보입니다.</p>
<figure class="shot"><img loading="lazy" src="manual/images/collection-apply-11.png" alt=""></figure>
...
<figure class="shot"><img loading="lazy" src="manual/images/collection-apply-12.png" alt=""></figure>
